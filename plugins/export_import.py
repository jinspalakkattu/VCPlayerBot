...
@Client.on_message(filters.command(["export", f"export@{Config.BOT_USERNAME}"]) & admin_filter & (
...
@Client.on_message(filters.command(["import", f"import@{Config.BOT_USERNAME}"]) & admin_filter & (
        filters.chat(Config.CHAT) | filters.private))
