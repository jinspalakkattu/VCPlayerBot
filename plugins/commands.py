...
HOME_TEXT = "<b>Hey  [{}](tg://user?id={}) 🙋‍♂️\n\nIam A Bot Built To Play or Stream Videos In Telegram " \
...
async def start(client, message):
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/joinchat/7qlEga5lO0o2MTg0'),
            InlineKeyboardButton('🧩 Source', url='https://github.com/jinspalakkattu/VCPlayerBot')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://github.com/jinspalakkattu/VCPlayerBot'),
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/joinchat/7qlEga5lO0o2MTg0'),

        ],
    ]
    await message.reply(
        "<b>The source code of this bot is public and can be found at <a "
        "href=https://github.com/jinspalakkattu/VCPlayerBot>VCPlayerBot.</a>"
        "\nYou can deploy your own bot and use in your "
        "group.\n\nFeel free to star☀️ the repo if you liked it 🙃.</b>",
        reply_markup=InlineKeyboardMarkup(buttons))
